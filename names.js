(function() {
    ...
    function init() {
        ...
        overlay.innerHTML = `
            <div style="color:#ffd700; font-weight:bold; margin-bottom:10px; font-size:20px;">ГОТОВЫЙ КОД:</div>
        ...
        Object.keys(data).forEach(id => {
            ...
            refs[id] = icon;
            // Список для второй страницы по твоему запросу
    ...
    function createIcon(id, x, y, size, parent) {
        ...
        wrap.ontouchmove = (e) => {
            ...
            if (e.touches.length === 1) { // Перемещение
            ...
            else if (e.touches.length === 2) { // Щипок (Pinch)
